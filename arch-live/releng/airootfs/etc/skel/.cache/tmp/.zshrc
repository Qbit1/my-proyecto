...
echo ""
echo -e "\e[34mBenvenuto su Core una live di Architalia.\e[0m"
echo ""

echo ""
echo -e "\e[33mLingua di sistema e della tastiera\e[0m"
localectl status
echo ""
...
echo -e "\e[33mStato Connessione\e[0m"

if ping -q -c 1 -W 1 8.8.8.8 >/dev/null; then
  rete
else
 echo -e "\e[31mSistema Disconnesso\e[0m"
fi
